...
const WA_PORTFOLIO_LINK = "https://wa.me/5562999999999?text=Ol%C3%A1%2C%20vim%20pelo%20site%20da%20Muniz%20Tech%20e%20gostaria%20de%20solicitar%20um%20or%C3%A7amento.";
    ...
    <>
      ...
      >
        ...
        <a
          ...
          className="flex items-center gap-3 text-white font-bold rounded-full shadow-xl px-5 py-3 transition-transform duration-300 hover:scale-105"
          style={{ backgroundColor: '#25D366' }}
          aria-label={isPortfolio ? "Solicitar orçamento no WhatsApp da MunizTech" : "Entrar no grupo do WhatsApp da MunizTech"}
        >
          ...
          <span className="text-sm whitespace-nowrap">
            {isPortfolio ? "Solicitar Orçamento" : "Entrar no Grupo"}
          </span>
        </a>
      </div>
    </>
